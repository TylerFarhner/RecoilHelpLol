...
import {verifyEmail} from '../../packages/backendsdk';

const STPCodeInputEmail = ({navigation}) => {
    const [warning, setWarning] = useState(null);
    const [counter, setCounter] = useState(null);
    const [value, setValue] = useRecoilState(EmailVerificationCode);
                ...
                <View style={styles.bottomContainer}>
                    ...
                    <View
                        ...
                        <Button
                            title="Verify"
                            onClick={() => {
                                verifyEmail(userInformation.email, value)
                                    .then((res) => {
                                        if (res.status === 200) {
                                            console.log('success');
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            if (!counter) {
                                ...
                                // Email verification code in here
                            } else {
                                setWarning(
...
export default STPCodeInputEmail;
